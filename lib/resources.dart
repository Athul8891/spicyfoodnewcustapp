...
const String nearByRest = "Restaurants nearby you";
const String cusReq =
...
const String card = "Credit, Debit ,ATM Cards, UPA ";
...
const Color accentColor = Color(0xffB62214);
...
ButtonStyle outLineBtn = ButtonStyle(
  shape: MaterialStateProperty.all<RoundedRectangleBorder>(
    RoundedRectangleBorder(
        side: BorderSide(width: 0.5, color: Colors.green[100])),
  ),
);
...
ButtonStyle menuButton = ButtonStyle(
  ...
  backgroundColor: MaterialStateProperty.resolveWith<Color>(
    (Set<MaterialState> states) {
      if (states.contains(MaterialState.pressed)) return Colors.grey[800];
      return Colors.grey[800]; // Use the component's default.
    },
  ),
);
...
ButtonStyle addButton = ButtonStyle(
  ...
  backgroundColor: MaterialStateProperty.resolveWith<Color>(
    (Set<MaterialState> states) {
      if (states.contains(MaterialState.pressed)) return Colors.grey[50];
